...
function wrapHtmlEmail(string $title, string $subtitle, string $bodyText, string $year, bool $bodyIsHtml = false, string $firstName = ''): string {
    ...
    $greetingHtml = $safeName
        ? '<p class="greeting" style="margin:0 0 8px 0;font-size:13px;color:#C9922A;font-family:Arial,sans-serif;letter-spacing:1.5px;text-transform:uppercase;">Season\'s Greetings ' . $safeName . '!</p>'
        : '';
